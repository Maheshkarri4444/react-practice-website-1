  ...
  return (
    <div className='flex flex-col items-center mt-6 lg:mt-20'>
        ...
        <div className='flex justify-center my-10'>
            <a href='#' className='bg-gradient-to-r from-orange-500 to-orange-800 py-3 px-4 mx-3 rounded-md whitespace-nowrap '>Start for free</a>
            <a href='#' className='py-3 px-4 mx-3 rounded-md border'>Documentation</a>
        </div>
        <div className='flex mt-2 w-full flex-col items-center justify-center sm:mt-10 sm:flex-row'>
            <video autoPlay loop muted className='rounded-lg w-4/5 border border-orange-700 shadow-orange-400 mx-2 my-4 sm:w-1/2'>
